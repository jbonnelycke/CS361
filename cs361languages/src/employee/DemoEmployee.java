...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		emp3.whoAmI();
		// TODO To complete
		// emp3.whoAmI() // prints "PART TIME EMPLOYEE" because it will always run the child/overridden method, and this is a PT Employee
		// emp3.getHourlyRate(); // returns syntax error because although this is a PT Employee object, it has an Employee reference, so 
		...
		// because downcasting sometimes throws an exception due to going from a more general object to a more specific one. 
