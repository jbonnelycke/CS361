 ...
 *
 * @see <A HREF="../../../../edu/colorado/geometry/Location.java"> Java Source
 *      Code for this class
 *      (www.cs.colorado.edu/~main/edu/colorado/geometry/Location.java) </A>
 *
...
public class Location implements Cloneable {
	 ...
	 * 
	 * @param xInitial the initial x coordinate of this Location
	 * @param yInitial the initial y coordinate of this Location
	 * @postcondition This Location has been initialized at the given coordinates.
	 **/
	 ...
	 * 
	 * @return The return value is a copy of this Location. Subsequent changes to
	 *         the copy will not affect the original, nor vice versa. Note that the
	 *         return value is a Location (not a plain Object) which is permitted
	 *         with Java 5.0.
	 **/
	@Override
	 ...
	 * @note The answer is Double.POSITIVE_INFINITY if the distance calculation
	 ...
	 * 
	 * @param obj an object with which this Location will be compared
	 * @return A return value of true indicates that obj refers to a Location object
	 *         with the same value as this Location. Otherwise the return value is
	 *         false.
	 * @note If obj is null or does not refer to a Location object, then the answer
	 *       is false.
	 **/
	@Override
	 ...
	 * @param p1 the first Location
	 * @param p2 the second Location
	 * @return a Location that is halfway between p1 and p2.
	 * @note The answer is null if either p1 or p2 is null.
	 **/
	 ...
	 * 
	 * @postcondition This Location has been rotated clockwise 90 degrees around the
	 *                origin.
	 **/
	 ...
	 * 
	 * @param xAmount the amount to move this Location along the x axis
	 * @param yAmount the amount to move this Location along the y axis
	 * @postcondition This Location has been moved by the given amounts along the
	 *                two axes.
	 * @note The shift may cause a coordinate to go above Double.MAX_VALUE or below
	 *       the minimum double value. In these cases, subsequent activations of
	 *       getX or getY will return Double.POSITIVE_INFINITY or
